...
public struct SwiftyiRate {
    ...
    private static let iRateDidOpenAppStore = "iRateDidOpenAppStore"
    
    private static let iRateAppStoreIDKey = "iRateAppStoreID"
    private static let iRateRatedVersionKey = "iRateRatedVersionChecked"
    private static let iRateDeclinedVersionKey = "iRateDeclinedVersion"
    private static let iRateLastRemindedKey = "iRateLastReminded"
    private static let iRateLastVersionUsedKey = "iRateLastVersionUsed"
    private static let iRateFirstUsedKey = "iRateFirstUsed"
    private static let iRateUseCountKey = "iRateUseCount"
    private static let iRateEventCountKey = "iRateEventCount"
    
    private static let iRateMacAppStoreBundleID = "com.apple.appstore"
    private static let iRateAppLookupURLFormat = "https://itunes.apple.com/%@/lookup"
    
    private static let iRateiOSAppStoreURLScheme = "itms-apps"
    private static let iRateiOSAppStoreURLFormat = "itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=%d&pageNumber=0&sortOrdering=2&mt=8"
    private static let iRateiOS7AppStoreURLFormat = "itms-apps://itunes.apple.com/app/id%d"
    private static let iRateMacAppStoreURLFormat = "macappstore://itunes.apple.com/app/id%d"
    
    private static let SECONDS_IN_A_DAY: Float  = 86400.0
    private static let SECONDS_IN_A_WEEK: Float = 604800.0
    private static let MAC_APP_STORE_REFRESH_DELAY: Float = 5.0
    private static let REQUEST_TIMEOUT: Double = 60.0
    ...
    public class SwiftyiRate: NSObject {
        ...
        func ratedVersion(version: String) -> Bool {
        ...
        /// 设置 app store ID
        func setAppStoreIDOnMainThread(appStoreID: Int) {
